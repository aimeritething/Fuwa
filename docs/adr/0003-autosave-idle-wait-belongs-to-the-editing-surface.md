...
status: accepted
date: 2026-09-10
amended: 2026-09-12 (rewritten in place)
---
...
- Fuwa's toasts belong to the file actions. Saving never shows one: a refused write is the error bar, a landed write is the path row's "Saved".
