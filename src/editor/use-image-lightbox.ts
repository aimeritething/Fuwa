...
import { trackInlineImageLightboxOpened } from '@/lib/product-analytics'
import { getDoubleClickedImageTarget, type ImageLightboxTarget } from './image-lightbox-target'
