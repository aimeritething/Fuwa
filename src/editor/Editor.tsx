...
import { useEditorTabSwap } from '@/kernel/resolve/useEditorTabSwap'
import { useEditorFocus } from './useEditorFocus'
import { useEditorTheme } from '@/shell/useTheme'
import { useEditorFocusScope } from './editorFocusOwnership'
import { RUNTIME_STYLE_NONCE } from '@/platform/runtimeStyleNonce'
import type { EditorMode, Tab } from '@/types'
import type { ListedFile } from '@/folder/explorer'
import { documentRoot } from '@/folder/explorer'
import { documentFrontmatter, frontmatterBadgeLabel } from '@/kernel/markdown/frontmatterStatus'
import { activeTabPaths, imageFetchVersion, imageMetadataLabel, type ImageNaturalSize } from '@/tabs/imageFile'
import { noteRootForPath } from '@/folder/noteEntry'
import { notePathFilename } from '@/lib/notePathIdentity'
import { dispatchEditorFindAvailability } from '@/kernel/blocknote/editorFindEvents'
import { installRichEditorMarkdownSerializer } from '@/kernel/markdown/richEditorMarkdown'
...
import { schema } from '@/kernel/blocknote/editorSchema'
import { createImeCompositionKeyGuardExtension } from '@/kernel/blocknote/imeCompositionKeyGuardExtension'
import { createMarkdownHighlightShortcutExtension } from '@/kernel/blocknote/markdownHighlightShortcutExtension'
...
import { createRichEditorFindExtension } from '@/kernel/blocknote/richEditorFind'
import { Toast } from './Toast'
import { TabBar } from '@/tabs/TabBar'
import { RICH_EDITOR_BLOCKNOTE_PERFORMANCE_OPTIONS } from '@/kernel/blocknote/richEditorBlockNoteOptions'
import { createRichEditorBlockSelectionExtension } from '@/kernel/blocknote/richEditorBlockSelectionExtension'
import { createRichEditorCodeBlockArrowNavigationExtension } from '@/kernel/blocknote/richEditorCodeBlockArrowNavigationExtension'
import { createRichEditorCodeBlockShortcutExtension } from '@/kernel/blocknote/richEditorCodeBlockShortcutExtension'
import { createRichEditorCodeBlockTabExtension } from '@/kernel/blocknote/richEditorCodeBlockTabExtension'
import { installRichEditorDispatchPerformanceProbe } from '@/kernel/blocknote/richEditorDispatchPerformance'
import { createRichEditorEmptyListNavigationExtension } from '@/kernel/blocknote/richEditorEmptyListNavigationExtension'
import { createRichEditorMarkdownInputTransformExtension } from '@/kernel/blocknote/richEditorInputTransformExtension'
import { createRichEditorListTabExtension } from '@/kernel/blocknote/richEditorListTabExtension'
import { createRichEditorPasteHandler } from '@/kernel/blocknote/richEditorPaste'
import { createRichEditorTextDirectionExtension } from '@/kernel/blocknote/richEditorTextDirection'
import { createRichEditorTransformErrorRecoveryExtension } from '@/kernel/blocknote/richEditorTransformErrorRecoveryExtension'
import { SingleEditorView } from './SingleEditorView'
import { createTodoBlockShortcutExtension } from '@/kernel/blocknote/todoBlockShortcutExtension'
import { useFilenameAutolinkGuard } from '@/kernel/blocknote/useFilenameAutolinkGuard'
