...
import { reportRecoveredEditorTransformError } from '@/kernel/blocknote/richEditorTransformErrorRecoveryExtension'

vi.mock('@/kernel/blocknote/richEditorTransformErrorRecoveryExtension', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/kernel/blocknote/richEditorTransformErrorRecoveryExtension')>()
  return {
    ...actual,
