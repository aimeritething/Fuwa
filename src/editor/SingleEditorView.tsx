...
import { useDocumentThemeMode } from '@/shell/useDocumentThemeMode'
import { useEditorTheme } from '@/shell/useTheme'
import { useImageDrop, type ImageImportError } from './useImageDrop'
import { useImageLightbox } from './useImageLightbox'
import type { AppLocale } from '@/lib/i18n'
import { observeNativeTextAssistanceDisabled } from '@/platform/nativeTextAssistance'
import type { VaultEntry } from '@/types'
import { insertImageBlockAfterCursor } from './editorImageInsertion'
import { useBlockNoteSideMenuHoverGuard } from '@/kernel/blocknote/blockNoteSideMenuHoverGuard'
import { useEditorLinkActivation } from '@/kernel/blocknote/useEditorLinkActivation'
import { ImageLightbox } from './ImageLightbox'
import { refreshCodeBlockSyntaxHighlighting } from '@/kernel/blocknote/editorCodeBlockHighlightRefresh'
import { subscribeRichEditorExternalChange } from '@/kernel/blocknote/editorExternalChangeEvents'
import {
...
} from '@/kernel/blocknote/blockNoteRenderRecovery'
import { repairEditorDocumentForRenderRecovery } from '@/kernel/blocknote/blockNoteRenderRecoveryDocument'
import { useEditorPasteHandler } from '@/kernel/blocknote/titleHeadingInteractions'
import {
  type SuggestionAction,
  useSuggestionMenuItems,
} from '@/kernel/blocknote/singleEditorSuggestionItems'
import {
  useEditorContainerClickHandler,
  useEditorWhitespaceMouseSelection,
} from '@/kernel/blocknote/singleEditorPointerInteractions'
import { useCompositionAwareEditorChange } from '@/kernel/blocknote/useCompositionAwareEditorChange'
import { useSeedBlockNoteTableBridge } from '@/kernel/blocknote/useSeedBlockNoteTableBridge'
import { EditorInteractionControllers } from './EditorInteractionControllers'
import { handleEditorCopy } from '@/kernel/blocknote/editorCopyHandlers'
import { CodeBlockCopyButton } from '@/kernel/blocknote/codeBlockCopyControls'
import { useCodeBlockCopyTarget } from '@/kernel/blocknote/useCodeBlockCopyTarget'
