...
vi.mock('@/kernel/blocknote/blockNoteSideMenuHoverGuard', () => ({
  useBlockNoteSideMenuHoverGuard: (containerRef: unknown) => state.hoverGuardMock(containerRef),
}))

vi.mock('@/kernel/blocknote/editorFormattingConfig', () => ({
  getSlashMenuItems: vi.fn(async () => []),
}))

vi.mock('@/kernel/blocknote/editorFormatting', () => ({
