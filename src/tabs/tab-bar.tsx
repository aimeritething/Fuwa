...
export const TabBar = memo(function TabBar({ tabs, activeTabPath, onActivate, onClose, sidebarCollapsed = false, onShowSidebar }: TabBarProps) {
  ...
  return (
    <div
      className="flex h-11 flex-none items-center gap-0.5 overflow-hidden border-b-hairline border-border-default pr-2.5 pl-2 select-none data-collapsed:pl-0"
      role="tablist"
      data-testid="tab-bar"
