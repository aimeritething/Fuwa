...
import { imageAssetUrl } from '../utils/imageAsset'
import type { ImageNaturalSize } from '../utils/imageFile'
import { FilePreviewFallback, FilePreviewImage } from './FilePreview'
import './ImageView.css'

/**
 * An Image Tab's body (spec section 4). The picture sits in the middle of the
