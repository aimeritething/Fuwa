...
import { clampEditorFindIndex, nextEditorFindIndex, type EditorFindOptions } from '../utils/editorFind'
import type { RawEditorFindRequest } from './rawEditorFindTypes'
import { collectRichFindMatches, setRichFindState, type RichFindResult } from './richEditorFind'
