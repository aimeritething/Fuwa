...
import { repairMalformedEditorBlocks } from '@/kernel/resolve/editor-block-repair'
import {
  classifyRichEditorRecoveryError,
  richEditorRecoveryErrorNeedsDocumentRepair,
  type RichEditorTransformRecoveryReason,
} from './rich-editor-recovery-classifier'
import { createMalformedBlockClipboardRecoveryPlugin } from './rich-editor-malformed-clipboard-recovery'
import type { RichEditorPropRunner, RichEditorSomeProp } from './rich-editor-transform-recovery-types'
export { isStaleBlockReferenceError } from './rich-editor-recovery-classifier'

const DISPATCH_RECOVERY_STATE_KEY = '__plumoRichEditorTransformErrorRecovery'
