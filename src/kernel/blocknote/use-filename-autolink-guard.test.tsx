...
vi.mock('./editor-link-autolink', () => ({
  shouldStripAutoLinkedLocalFileMark: shouldStripAutoLinkedLocalFileMarkMock,
}))

import { useFilenameAutolinkGuard } from './use-filename-autolink-guard'
...
describe('use-filename-autolink-guard', () => {
  ...
  it('removes accidental filename link marks and tags the transaction to avoid loops', () => {
    ...
    expect(fixture.tr.setMeta).toHaveBeenCalledWith('filename-autolink-guard', true)
