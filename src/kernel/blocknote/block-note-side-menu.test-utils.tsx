...
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- the fixture mocks are called with whatever the side menu passes
...
export type MockEditor = {
  ...
  focus: AnyMock
  getBlock: AnyMock
  insertBlocks: AnyMock
  onChange: AnyMock
  removeBlocks: AnyMock
  setTextCursorPosition: AnyMock
...
export let mockSideMenu: {
  blockDragEnd: AnyMock
  blockDragStart: AnyMock
  freezeMenu: AnyMock
  unfreezeMenu: AnyMock
}
export let mockSuggestionMenu: { openSuggestionMenu: AnyMock }
