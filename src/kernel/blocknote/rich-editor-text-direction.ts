...
export const RICH_EDITOR_RTL_DIRECTION_CLASS = 'plumo-rich-editor-text-direction-rtl'

type RichEditorDirection = 'auto' | 'rtl'

const textDirectionPluginKey = new PluginKey<ProsemirrorDecorationSet>('rich-editor-text-direction')
...
export const createRichEditorTextDirectionExtension = createExtension(() => ({
  key: 'rich-editor-text-direction',
  prosemirrorPlugins: [
