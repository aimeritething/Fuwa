...
import { APP_COMMAND_EVENT_NAME, APP_COMMAND_IDS } from '@/shell/appCommandDispatcher'
import { HTML_BLOCK_DEFAULT_HEIGHT, HTML_BLOCK_TYPE, type HtmlBlockScripts } from '@/kernel/markdown/htmlBlockMarkdown'
import { HtmlBlock, type HtmlBlockEditor, type HtmlBlockProps } from './HtmlBlock'

vi.mock('@/platform/clipboardText', () => ({
