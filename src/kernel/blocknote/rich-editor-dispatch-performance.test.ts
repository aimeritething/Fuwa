...
vi.mock('@/kernel/resolve/editor-performance-trace', () => ({
  logRichEditorDispatchTrace: vi.fn(),
}))

import { logRichEditorDispatchTrace } from '@/kernel/resolve/editor-performance-trace'
import { installRichEditorDispatchPerformanceProbe } from './rich-editor-dispatch-performance'
