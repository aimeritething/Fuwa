...
import { OpenEditors } from '@/tabs/OpenEditors'
import { Explorer } from '@/explorer/Explorer'
import { useFolder, pickFolderToOpen } from '@/folder/useFolder'
import { useExplorerActions } from '@/explorer/useExplorerActions'
import { useDocumentWatcher } from '@/folder/useDocumentWatcher'
import { buildExplorerTree, documentRoot } from '@/folder/explorer'
import { activeTabPaths } from '@/tabs/imageFile'
import { findByNotePath } from '@/lib/notePathIdentity'
import { isWithinPrefix } from '@/folder/folderActionUtils'
import { Sidebar } from '@/shell/Sidebar'
import { useAppearance } from '@/shell/useAppearance'
import { WriteFailureDialog } from '@/editor/WriteFailureDialog'
import { dispatchAppCommand, isAppCommandId } from '@/shell/appCommandDispatcher'
import { commandMenuCommandEntries, commandMenuFileEntries } from '@/command-menu/commandMenuEntries'
import { useAppKeyboard } from '@/shell/useAppKeyboard'
import { useCommandMenu } from '@/command-menu/useCommandMenu'
import { useDocumentDrop } from '@/tabs/useDocumentDrop'
import { useEditorSave } from '@/editor/useEditorSave'
import { useFinderOpen } from '@/tabs/useFinderOpen'
import { useMenuEvents, type MenuEventHandlers } from '@/shell/useMenuEvents'
import { useNoteTabs } from '@/tabs/useNoteTabs'
import { useSession } from '@/session/useSession'
import { useSidebar } from '@/shell/useSidebar'
import { useToast } from '@/editor/useToast'
import { useTabCommands } from '@/tabs/useTabCommands'
import { useThemeMode } from '@/shell/useThemeMode'
import { useWriteFailureRecord, useWriteFailures } from '@/editor/useWriteFailures'
import { closeAppWindow, exitApp } from '@/platform/appWindow'
import { pickNoteToOpen } from '@/tabs/noteOpenDialog'
import { openNotesSettled } from '@/tabs/noteOpenRequest'
import { requestPlainTextPaste } from '@/editor/plainTextPaste'
