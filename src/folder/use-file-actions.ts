...
import { folderAbsolutePath } from './folder-action-utils'
import { copyLocalPath, openLocalFile, revealLocalPath } from '@/platform/url'
import {
  translate,
  type AppLocale,
  type TranslationKey,
} from '@/lib/i18n'
import { localizedStreamErrorMessage as localizedErrorMessage } from '@/lib/localized-stream-error'
