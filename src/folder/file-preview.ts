/**
 * What makes a file an Image file (CONTEXT.md): Plumo shows it and never edits
 ...
 * Image Tab. The kernel's pdf, audio and video branches are trimmed away:
 * Plumo previews nothing else.
 */
